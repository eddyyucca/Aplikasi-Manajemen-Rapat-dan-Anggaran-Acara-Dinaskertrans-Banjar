...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 08 Mar 2021 pada 12.58
...
--
-- Struktur dari tabel `tb_detil_surat`
--
...
--
-- Dumping data untuk tabel `tb_detil_surat`
--
...
--
-- Dumping data untuk tabel `tb_honor`
--
...
('1111', 'Lisa', '$2y$10$UDUW.GPpZzh0/S.b.qQb7uRjobETAQK3rsDL2b7e9OMwsGRcTxiH2', 'staff', 'Staff'),
('12345', 'syarif', '$2y$10$UnWNbnJe/i5/PqmC9i05Bee43qsz.Tzntjo5BrQxik9pk0LlkQuh2', 'admin', 'Admin'),
('16630001', 'Akhmad Rifai', '$2y$10$VseJAOTXzQdoq4363V53Uu59lM269IvKM6F3fQi233bGvUi9uCOTm', 'sekwan', 'Kabag Sekwan'),
('16630002', 'Simbadda', '$2y$10$eQcKEUTKWcEc3uMWwg4Imetn/YHSVCOdG2KF7woiH40wEzZmHjGw2', 'organ', 'Kabag Organisasi'),
('16630003', 'Ade Naufhaldy', '$2y$10$SNFYobpj9MfoKbMUdRaeYu8xB3LCW8vOsABMov24eg5/3zgL9/C16', 'hukum', 'Kabag Hukum'),
('16630004', 'Khalid', '$2y$10$V7ENvOGLmEBrEutN./Edo.duN/QwZRfhKZfYx/.djSpqrEtAQYpKe', 'umum', 'Kabag Umum'),
('16630005', 'Randy', '$2y$10$RJia2k.34L.K.FnlkuPMHuVwxDhbDCAycLYmNM5Abgp1jHFHeSHQW', 'admin', 'Admin'),
('16630009', 'Fahmiah, S.Pd', '$2y$10$SR7jNpuqg4Ff12L60qSOaudthreEY7s1OWFJ02EBuZCm/AAGzliYW', 'staff', 'Staff'),
('16630568', 'Cindy', '$2y$10$dxVlKKbL8lzsTFvLRFL95uIGqzxUgkvlyY4GqJwBpgZb3C7unRnvK', 'admin', 'Admin');
...
--
-- AUTO_INCREMENT untuk tabel `tb_honor`
--
ALTER TABLE `tb_honor`
