...
$this->myfpdf->Cell(190,8,'LAPORAN DATA ID ACCOUNT',0,1,'C');

$this->myfpdf->Ln(5);
$this->myfpdf->SetFont('Times','B',11);
$this->myfpdf->Cell(10,7,'NO.',1,0,'C');
$this->myfpdf->Cell(60,7,'NIP',1,0,'C');
$this->myfpdf->Cell(60,7,'NAMA',1,0,'C');
$this->myfpdf->Cell(60,7,'JABATAN',1,1,'C');

$this->myfpdf->SetFont('Times','',10);
$no = 1;
foreach($pegawai as $s) { 
    $this->myfpdf->Cell(10,7,$no,1,0,'C');
    $this->myfpdf->Cell(60,7,$s['nip'],1,0,'');
    $this->myfpdf->Cell(60,7,$s['nama'],1,0,'');
    $this->myfpdf->Cell(60,7,$s['bagian'],1,1,'');
...
$this->myfpdf->Output('D','Data ID ACCOUNT.pdf');
?>
