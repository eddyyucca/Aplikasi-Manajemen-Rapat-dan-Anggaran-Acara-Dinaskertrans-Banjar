...
$this->myfpdf->Cell(190,8,'LAPORAN SURAT MASUK',0,1,'C');
$this->myfpdf->Ln(3);
...
$this->myfpdf->Cell(55,7,'Asal Surat',1,1,'C');
...
foreach($sm as $s) { 
    ...
    $this->myfpdf->Cell(55,7,$s['nm_pengirim'],1,1,'C');
...
$this->myfpdf->Output('D','Surat-Masuk.pdf');
?>
