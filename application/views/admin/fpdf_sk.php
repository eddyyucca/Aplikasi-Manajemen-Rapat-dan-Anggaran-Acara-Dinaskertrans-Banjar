...
$this->myfpdf->Cell(190,8,'LAPORAN SURAT KELUAR',0,1,'C');
$this->myfpdf->Ln(3);
...
$this->myfpdf->Cell(30,8,'Tujuan Surat',0,0,'');
$this->myfpdf->Cell(5,8,':',0,0,'');
$this->myfpdf->Cell(100,8,$tujuan,0,1,'');

$this->myfpdf->Ln(3);
$this->myfpdf->SetFont('Times','B',10);
$this->myfpdf->Cell(10,7,'No.',1,0,'C');
$this->myfpdf->Cell(40,7,'No Surat',1,0,'C');
$this->myfpdf->Cell(25,7,'Tanggal Surat',1,0,'C');
$this->myfpdf->Cell(60,7,'Perihal',1,0,'C');
$this->myfpdf->Cell(55,7,'Tempat Acara',1,1,'C');

$this->myfpdf->SetFont('Times','',10);
$no = 1;
foreach($sk as $s) { 
    $this->myfpdf->Cell(10,7,$no,1,0,'C');
    $this->myfpdf->Cell(40,7,$s['no_surat'],1,0,'C');
    $this->myfpdf->Cell(25,7,$s['tanggal'],1,0,'C');
    $this->myfpdf->Cell(60,7,$s['perihal'],1,0,'C');
    $this->myfpdf->Cell(55,7,$s['tempat'],1,1,'C');
...
$this->myfpdf->Output('D','Surat-Keluar.pdf');
?>
