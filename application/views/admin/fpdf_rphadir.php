...
$this->myfpdf->Cell(30,7,'Jenis Rapat',1,0,'C');
$this->myfpdf->Cell(50,7,'File Daftar Hadir',1,1,'C');
...
foreach($hadir as $s) { 
    ...
    $this->myfpdf->Cell(30,7,$s['tujuan'],1,0,'C');
    $this->myfpdf->SetFont('Times','',8);
    $this->myfpdf->Cell(50,7,$s['daftar_hadir'],1,1,'C');
...
$this->myfpdf->Output('D','Laporan Daftar Hadir.pdf');
?>
