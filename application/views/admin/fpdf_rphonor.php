...
$this->myfpdf->Cell(190,8,'LAPORAN HONORARIUM RAPAT',0,1,'C');
$this->myfpdf->Ln(3);
...
$this->myfpdf->Cell(50,7,'No Honor',1,0,'C');
$this->myfpdf->Cell(50,7,'Tgl Honor',1,0,'C');
$this->myfpdf->Cell(45,7,'Nominal',1,0,'C');
...
foreach($honor as $s) { 
    $this->myfpdf->Cell(10,7,$no,1,0,'C');
    $this->myfpdf->Cell(50,7,$s['no_honor'],1,0,'C');
    $this->myfpdf->Cell(50,7,$s['tgl_honor'],1,0,'C');
    $this->myfpdf->Cell(45,7,'Rp. '.number_format($s['nominal'],2,".",",") ,1,0,'C');
...
$this->myfpdf->Output('D','Honorarium Rapat_'.$awal.'-'.$akhir.'.pdf');
?>
